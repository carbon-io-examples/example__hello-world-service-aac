...
```
$ git clone -b carbon-0.6 git@github.com:carbon-io-examples/example__hello-world-service-aac.git
...
http://htmlpreview.github.io/?https://raw.githubusercontent.com/carbon-io-examples/example__hello-world-service-aac/blob/carbon-0.6/docs/index.html)
